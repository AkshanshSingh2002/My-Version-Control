...
const genreateActivityData = (statDate, endDate) => {
	const data = [];
	let currentDate = new Date(statDate);
...
const getPanelColors = (maxCount) => {
	...
	console.log("Panel Colors:", colors);
	return colors;
};
...
const HeatMapProfile = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			const data = genreateActivityData(startDate, endDate);
